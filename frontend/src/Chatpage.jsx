...
export default function ChatPage() {
    ...
    const [firstAgentMessage, setFirstAgentMessage] = useState(null); // Track first response for tone verification
    ...
    const handleElevenLabsMessage = useCallback((message) => {
        ...
        if (textContent) {
            setChatMessages(prev => {
                ...
                // Track first agent message for tone verification
                if (isAgentMessage && !firstAgentMessage) {
                    setFirstAgentMessage(textContent);
                    console.log("\n" + "=".repeat(60));
                    console.log("🎯 FIRST AGENT RESPONSE (Tone Verification)");
                    console.log("=".repeat(60));
                    console.log("🎭 Persona:", selectedPersona?.name || "Default");
                    console.log("💬 Response:", textContent);
                    console.log("📝 Expected Tone:", selectedPersona?.description || "N/A");
                    console.log("=".repeat(60) + "\n");
                }
    ...
    }, [firstAgentMessage, selectedPersona]);
    ...
    const conversation = useConversation({
        onConnect: () => {
            ...
            console.log("=".repeat(60));
            console.log("🎭 Active Agent:", selectedPersona?.name || "Default");
            console.log("🆔 Agent ID:", selectedPersona?.agentId || import.meta.env.VITE_ELEVENLABS_AGENT_ID);
            console.log("💬 Conversation Tone:", selectedPersona?.description || "Default");
            console.log("🎤 Ready to listen and respond");
            console.log("=".repeat(60) + "\n");
        ...
        onDisconnect: () => {
            ...
            console.log("=".repeat(60));
            console.log("🎭 Was using:", selectedPersona?.name || "Default");
            console.log("=".repeat(60) + "\n");
            isConnecting.current = false;
        },
        onMessage: (message) => {
            ...
            console.log("  Content:", message.message || message.text || message.content);
            console.log("  Agent:", selectedPersona?.name || "Default");
            handleElevenLabsMessage(message);
        },
        onError: (error) => {
            console.error("\n⚠️ ERROR OCCURRED:");
            console.error("  Agent:", selectedPersona?.name || "Default");
    ...
    const toggleConnection = async () => {
        ...
        if (isConnected) {
            ...
            try {
                ...
                console.log("=".repeat(60));
                console.log("👤 Active Persona:", selectedPersona?.name || "Default");
                console.log("🎭 Persona Role:", selectedPersona?.tagline || "N/A");
                console.log("💬 Tone/Personality:", selectedPersona?.description || "N/A");
                console.log("🆔 ElevenLabs Agent ID:", agentId);
                console.log("🎨 Visual Theme:", selectedPersona?.color || "Default");
                console.log("🎯 Avatar Model:", selectedPersona?.avatar || "Default");
                console.log("=".repeat(60) + "\n");
                ...
                console.log("⚙️ Session Config:", JSON.stringify(sessionConfig, null, 2));
                console.log("🔌 Initiating ElevenLabs connection...\n");
    ...
    const handlePersonaClick = (persona) => {
        ...
        console.log("=".repeat(60));
        console.log("📛 Name:", persona.name, "|", persona.hindiName);
        console.log("🎯 Role:", persona.tagline);
        console.log("📝 Description:", persona.description);
        console.log("🆔 Agent ID:", persona.agentId);
        console.log("🎨 Theme Color:", persona.color);
        console.log("⚠️  IMPORTANT: Ensure this agent has a unique system prompt in ElevenLabs dashboard!");
        console.log("=".repeat(60) + "\n");
